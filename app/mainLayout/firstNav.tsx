            ...
            <div className="w-[95%] lg:w-[90%] mx-auto flex flex-col lg:flex-row items-center justify-between gap-6 mt-5">
                ...
                <div className="relative w-full lg:w-auto">
                    ...
                    <input
                        ...
                        className="w-full bg-[#F3F3F3] text-[#757575] placeholder-[#757575] text-lg rounded-full py-2.5 pl-14 pr-6 focus:outline-none focus:ring-2 focus:ring-gray-300 transition-all"
                    />
                </div>
